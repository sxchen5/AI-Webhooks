...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'active-scan/repos', name: 'ActiveScanRepos', meta: { title: '项目管理' }, component: () => import('@/views/ActiveScanRepoListView.vue') },
      { path: 'active-scan/jobs', name: 'ActiveScanJobs', meta: { title: '下发任务管理' }, component: () => import('@/views/ActiveScanJobListView.vue') },
      { path: 'active-scan/logs', name: 'ActiveScanLogs', meta: { title: '下发日志' }, component: () => import('@/views/ActiveScanLogListView.vue') },
